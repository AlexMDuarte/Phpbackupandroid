...
Ao clicar em **Testar tudo**, a página instala e abre automaticamente a APK `manual-tests` no equipamento selecionado através de ADB. A instalação é normal e pode pedir permissões no Android.
